...
func Test_mysql_SaveLocalStorage(t *testing.T) {
	// Create a mysql instance with a test database connection
	ctx := context.Background()
	_, db := mockdata.NewMySQLMock(t)
	repo := &mysql{
		Sql: db,
		Log: log.NewLog(),
	}
...
func Test_mysql_DeleteLocalStorage(t *testing.T) {
	// Create a mysql instance with a test database connection
	ctx := context.Background()
	_, db := mockdata.NewMySQLMock(t)
	repo := &mysql{
