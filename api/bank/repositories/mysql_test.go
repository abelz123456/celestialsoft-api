...
// mysql.GetCollection
func Test_mysql_GetCollection(t *testing.T) {
...
// mysql.GetOneByCode
func Test_mysql_GetOneByCode(t *testing.T) {
	t.Run("Success", func(t *testing.T) {
		mock, repo, ctx := initMySQLMock(t)
...
// mysql.GetOneByOid
func Test_mysql_GetOneByOid(t *testing.T) {
	t.Run("Success", func(t *testing.T) {
		mock, repo, ctx := initMySQLMock(t)
...
// mysql.UpdateOne
func Test_mysql_UpdateOne(t *testing.T) {
	t.Run("Success", func(t *testing.T) {
		mock, repo, ctx := initMySQLMock(t)
